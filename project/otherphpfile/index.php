...
<body class="app">   	
		        ...
		        <div class="app-header-content"> 
					...
					<?php echo    'WelCome '.$_SESSION["Name"].' '; ?>
			            <div class="app-utility-item app-user-dropdown dropdown">
				            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="../assets/Image/user.png" alt="user profile"></a>
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="index.html"><img class="img-fluid w-75" src="../assets/Image/logo-header.png" alt="logo"/></a>
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
	  ...
	  <path d="M6 0h7a2 2 0 0 1 2 2  v10a2 2 0 0 1-2 2v-1a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1H4a2 2 0 0 1 2-2z"/>
	</svg>
						         </span>
